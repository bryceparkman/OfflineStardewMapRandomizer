...
{
    public class SVEMapData
    {
        public static Dictionary<string, string> sveWarpConversions = new()
        {
        ...
        public static List<string> sveEarlyMapWarps = new()
        {
        ...
        public static List<string> sveEarlyWarps = new()
        {
        ...
        public static List<string> sveMapLocations = new()
        {
            "Custom_ForestWest",
        ...
        public static List<string> sveWarps = new()
        {
